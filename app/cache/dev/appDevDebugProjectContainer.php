...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8888, 'dbname' => 'FarmUtilizing', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8821caa214129899b4b01f1e50e43057');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8821caa214129899b4b01f1e50e43057');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8821caa214129899b4b01f1e50e43057');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/FarmUtilizing/CommonBundle/Entity'))), 'FarmUtilizing\\CommonBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('CommonBundle' => 'FarmUtilizing\\CommonBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FarmUtilizing\\CommonBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FarmUtilizing\\CommonBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FarmUtilizing\\CommonBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FarmUtilizing\\CommonBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FarmUtilizing\\CommonBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/FarmUtilizing/FrontBundle/Resources/views'), 'Front');
        $instance->addPath(($this->targetDirs[3].'/src/FarmUtilizing/AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'/src/FarmUtilizing/CommonBundle/Resources/views'), 'Common');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FrontBundle' => 'FarmUtilizing\\FrontBundle\\FrontBundle',
                'AdminBundle' => 'FarmUtilizing\\AdminBundle\\AdminBundle',
                'CommonBundle' => 'FarmUtilizing\\CommonBundle\\CommonBundle',
            ...
            'fos_user.model.user.class' => 'FarmUtilizing\\CommonBundle\\Entity\\User',
