...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8888, 'dbname' => 'blogsymfony2', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_d9d88befb66197d24d0c38aa350141de');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d9d88befb66197d24d0c38aa350141de');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d9d88befb66197d24d0c38aa350141de');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DreamMarket/ClientBundle/Entity'))), 'DreamMarket\\ClientBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DreamMarketClientBundle' => 'DreamMarket\\ClientBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DreamMarket/ClientBundle/Resources/views'), 'DreamMarketClient');
        $instance->addPath(($this->targetDirs[3].'/src/DreamMarket/AdminBundle/Resources/views'), 'DreamMarketAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DreamMarketClientBundle' => 'DreamMarket\\ClientBundle\\DreamMarketClientBundle',
                'DreamMarketAdminBundle' => 'DreamMarket\\AdminBundle\\DreamMarketAdminBundle',
            ),
